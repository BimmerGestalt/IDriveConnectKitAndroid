...
enum class KnownSecurityServices(val className: String,
	...
	BMWMineCN("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.bmw.connected.mobile20.cn"),
	MiniMineCN("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.mini.connected.mobile20.cn"),
	J29MineCN("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.j29.connected.mobile20.cn"),
	BMWMineHK("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.bmw.connected.mobile20.hm"),
	MiniMineHK("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.mini.connected.mobile20.hm"),
	J29MineHK("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.j29.connected.mobile20.hm"),
	BMWMineKR("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.bmw.connected.mobile20.kr"),
	MiniMineKR("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.mini.connected.mobile20.kr"),
	J29MineKR("com.bmwgroup.connected.core.services.security.CarSecurityService", "de.j29.connected.mobile20.kr"),
